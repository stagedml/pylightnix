...
background services, it is totally up ot you. Read the [initialize
docstring reference](../Reference.md#pylightnix.core.initialize) for
details.
...
storage, just call `initialize()` without arguments.
